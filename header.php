...
<html itemscope class="no-js lt-ie9 lt-ie8 lt-ie7" <?php language_attributes(); ?>> <![endif]--><!--[if IE 7]>
<html itemscope class="no-js lt-ie9 lt-ie8" <?php language_attributes(); ?>> <![endif]--><!--[if IE 8]>
<html itemscope class="no-js lt-ie9" <?php language_attributes(); ?>> <![endif]--><!--[if gt IE 8]><!-->
<html itemscope class="no-js" <?php language_attributes(); ?>> <!--<![endif]-->
<head>
