...
if ( isset( $_GET[ 's' ] ) ) {
	...
	echo tell_get_image_src( $archive_image, 1920, 400 ); ?>');">
		...
		<h1 class="white-col"><?php _e( 'Search', 'local' ); ?></h1>
	</div>

	<div class="container padding-top-60">
		<div class="row cf">
			<div class="col-md-9 blog-archive-page">
				<div data-post-type="tours,excursions,cruises,hotels,rooms,car-rentals,post" data-number-of-posts="<?php echo get_option( 'posts_per_page' ); ?>" data-offset="<?php echo get_option( 'posts_per_page' ); ?>" data-search="<?php echo $search; ?>">
					<div class="place-for-upload cf">
						<?php wp_reset_query();
