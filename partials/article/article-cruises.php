<div class="col-sm-6 margin-bottom-30">
	<article <?php post_class( 'archive-cruises-item card-shadow flex-box transition' ); ?>>
		<div class="image">
		...
		<div class="text cf white-bg">
			...
			<div class="details">
				<?php $current_category = wp_get_post_terms( $post->ID, 'cruises-country', array( "fields" => "all" ) );
				foreach ( $current_category as $category ) {
					$link = get_term_link( $category->slug, 'cruises-country' );
				...
				<?php if ( tell_get_meta( 'cruises_duration' ) ) { ?>
					<span><i class="material-icons">alarm</i><?php echo tell_get_meta( 'cruises_duration' ); ?></span>
				<?php } ?>
